...
class MyTestCase(unittest.TestCase):
    def test_tic_tac_toe_ai_1(self):
        ...
        self.assertEqual(tic_tac_toe_ai.get_next_move_cell(), (0, 2))
    ...
    def test_tic_tac_toe_ai_2(self):
        ...
        tic_tac_toe_ai = TicTacToeAI(board)
        self.assertEqual(tic_tac_toe_ai.get_next_move_cell(), (1, 2))
    ...
    def test_tic_tac_toe_ai_3(self):
        ...
        tic_tac_toe_ai = TicTacToeAI(board)
        self.assertEqual(tic_tac_toe_ai.get_next_move_cell(), (2, 2))
    ...
    def test_tic_tac_toe_ai_4(self):
        ...
        tic_tac_toe_ai = TicTacToeAI(board)
        self.assertEqual(tic_tac_toe_ai.get_next_move_cell(), (1, 0))
